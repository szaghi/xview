...
implicit none
private
public :: procinput_object

type :: procinput_object
...
endtype procinput_object

contains
   pure function description(self) result(desc)
   !< Return a pretty-formatted object description.
   class(procinput_object), intent(in) :: self             !< File data.
   ...
   class(procinput_object), intent(inout) :: self !< File data.
  ...
  if (self%filename/='') inquire(file=trim(adjustl(self%filename)), exist=is_present)
   ...
   elseif (self%is_file_present()) then
      ...
      error stop 'error: nor "filename" neither "self%filename" have been specified for "procinput_object%save_file" method!'
   endif
   write(file_unit, *) self%description()
   close(file_unit)
   endsubroutine save_file
endmodule xview_procinput_object
